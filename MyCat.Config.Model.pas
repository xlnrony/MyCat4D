...
type
  ...
  private
    static final int DEFAULT_MANAGER_PORT = 9066;
  private
    static final String DEFAULT_CHARSET = " utf8 ";

  private
    static final String DEFAULT_SQL_PARSER = " druidparser ";
    // fdbparser, druidparser
  private
    static final short DEFAULT_BUFFER_CHUNK_SIZE = 4096;
  private
    static final int DEFAULT_BUFFER_POOL_PAGE_SIZE = 512 * 1024 * 4;
  private
    static final short DEFAULT_BUFFER_POOL_PAGE_NUMBER = 64;
    //
  private
    static final int DEFAULT_PROCESSORS = Runtime.getRuntime()
      .availableProcessors();
  private
    final static String RESERVED_SYSTEM_MEMORY_BYTES = " 384 m ";
  private
    final static String MEMORY_PAGE_SIZE = " 1 m ";
  private
    final static String SPILLS_FILE_BUFFER_SIZE = " 2 K ";
  private
    final static String DATANODE_SORTED_TEMP_DIR = " datanode ";
  private
  ...
  TDBHostConfig = class
  private
    FIdleTimeout: long = SystemConfig.DEFAULT_IDLE_TIMEOUT; // 连接池中连接空闲超时时间
    FHostName: string;
    FIP: String;
    FPort: Integer;
    FUrl: String;
    ...
    FMinConn: Integer;
    FDBType: string;
    FFilters: String = 'MergeStat';
    FLogTime: int64 = 300000;
    FWeight: Integer;
  public
...
begin
  FIdleTimeout := SystemConfig.DEFAULT_IDLE_TIMEOUT; // 连接池中连接空闲超时时间
  FFilters := 'MergeStat';
  FLogTime := 300000;
