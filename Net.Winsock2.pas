...
{$EXTERNALSYM AI_FILESERVER}
  ...
  // Resolving fileserver name resolution (Windows 7 or later)
...
begin
  ...
  begin
    ...
    if hMSWSockDll = 0 then
    begin
      raise EIdWinsockStubError.Build(Windows.GetLastError, RSWinsockLoadError,
        [MSWSOCK_DLL]);
    end;
  end;
end;
...
begin
  ...
  Result := Windows.GetProcAddress(hDll,
